 ...
 * @Description: 将DECIMAL类型字段转换成Double字段
 * @CreateDate: 2019-07-26 11:11
 * @UpdateDate: 2019-07-26 11:11
...
public class MyJavaTypeResolver implements JavaTypeResolver {
    ...
    public MyJavaTypeResolver() {
        ...
        this.typeMap.put(-5, new JavaTypeResolverDefaultImpl.JdbcTypeInformation("BIGINT", new FullyQualifiedJavaType(Double.class.getName())));
