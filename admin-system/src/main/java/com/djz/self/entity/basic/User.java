...
public class User implements Serializable {
    ...
    public User(Long id, String code, String userName, String realName, String password, Integer age, String email, Short sex, String phone, String creatorId, String updatorId, String creatorName, String operatorName, String defaultTheme, String lastIp, Date lastTime, Date createTime, Date operateTime, Short status, Short superman) {
        this.id = id;
        this.code = code;
